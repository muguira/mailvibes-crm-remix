-- Fix RPC function return types to match database schema
...
RETURNS TABLE(
    ...
    email CHARACTER VARYING,  -- Match the actual database type
    role CHARACTER VARYING,   -- Match the actual database type
    status CHARACTER VARYING, -- Match the actual database type
    invited_by UUID,
...
SELECT 'RPC function fixed with correct return types!' as status; 