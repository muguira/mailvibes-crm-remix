...
const Imports = () => {
    ...
    const importOptions: ImportOption[] = [
        ...
        },
        {
            id: 'gmail',
            name: 'Gmail Import',
            description: 'Import contacts directly from your Google Contacts. Connect your Gmail account and sync your contacts.',
                            ...
                            <Card className="p-6 bg-white shadow-sm mb-6">
                                <div className="mb-6">
                                    ...
                                    <p className="text-gray-600">
                                        Choose how you want to import your contacts into Mailvibes CRM
                                    </p>
                                </div>
