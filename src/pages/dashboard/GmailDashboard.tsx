    ...
    return (
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-6">
            <Button variant="ghost" onClick={handleBackToIntegrations} className="mb-4">
          ...
          <div className="flex items-center justify-center p-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">{loading ? 'Loading Gmail accounts...' : 'Initializing Gmail service...'}</p>
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <Alert className="mb-4" variant="destructive">
            ...
            <AlertDescription>Failed to initialize Gmail service: {displayError}</AlertDescription>
          </Alert>
