  ...
  const integrationOptions: IntegrationOption[] = [
    {
      name: 'Gmail',
      description:
        'Connect your Gmail account to import contacts and sync email history. View email timelines in contact profiles and automatically sync new emails. Requires a Google account.',
      icon: '📧',
    ...
    },
    {
      name: 'HubSpot',
      description:
        'Add new leads from HubSpot and update HubSpot contacts with information from RelateIQ to create more targeted marketing campaigns. Requires a HubSpot login.',
      icon: '🔗',
    ...
    },
    {
      name: 'MailChimp',
      description:
        'Add new leads from MailChimp and update MailChimp contacts with information from RelateIQ to create more targeted marketing campaigns. Requires a MailChimp login.',
      icon: '📧',
    ...
    },
    {
      name: 'Google Sheets',
      description:
        'Sync your contact data with Google Sheets to create custom reports and analyze your data. Import contacts from spreadsheets and keep your data in sync. Requires a Google account.',
      icon: '📝',
    ...
    },
    {
      name: 'Copper',
      description:
        'Connect with Copper CRM to synchronize contacts, deals, and activities. Streamline your workflow by keeping both systems up to date automatically. Requires a Copper account.',
      icon: '🔄',
        ...
        <div className="flex gap-8">
          ...
          <div className="w-64">
            <div className="space-y-1">
              ...
              <nav className="flex flex-col space-y-1">
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted" onClick={() => navigate('/settings')}>
                  Your Information
                </button>
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">Security</button>
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">Notifications</button>
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">Connected Accounts</button>
              </nav>

              <h2 className="text-lg font-medium mt-8 mb-4">Organization Settings</h2>
              <nav className="flex flex-col space-y-1">
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">General</button>
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">Sharing</button>
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">Lists</button>
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">Users</button>
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">Teams</button>
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">Billing</button>
                <button className="px-4 py-2 text-left rounded-lg hover:bg-muted">Account Properties</button>
          ...
          <div className="flex-1">
            ...
            <Card className="p-6 mb-6">
              ...
              <GmailAccountsList onAccountDisconnected={handleGmailAccountDisconnected} />
            </Card>
