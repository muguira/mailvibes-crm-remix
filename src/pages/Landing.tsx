    ...
    <div className="min-h-screen bg-gradient-to-b from-navy-deep to-navy-light text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 50% 0%, rgba(5, 66, 88, 0.3) 0%, rgba(5, 66, 88, 0.1) 70%, transparent 100%)',
          }}
        ></div>
      </div>
          ...
          <div className="relative z-10">
            <h1 className="text-5xl md:text-6xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-white to-white/80">
              ...
              <span className="text-teal-primary font-sans">
                ...
                <span className="font-normal">Sheets</span>
              </span>
            </h1>
            <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Streamline your sales workflow, manage leads effectively, and close more deals with our intelligent CRM
              platform.
            </p>
          ...
          >
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(to top, #184A5D 5%, #184A5D 2%, #184A5D 1%, rgba(13, 52, 65, 0.4) 60%, rgba(13, 52, 65, 0) 100%)',
                }}
              ></div>
            </div>
          </motion.div>
              ...
              >
                <svg className="w-8 h-8 text-teal-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h2v4l.586-.586z"
                  />
                </svg>
              </motion.div>
              <motion.h3
          ...
          <div className="relative mt-10 md:mt-20">
                    ...
                    <div className="bg-teal-primary/20 p-2 rounded-lg">
                      <svg className="w-6 h-6 text-teal-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M4 7v10c0 2 1.5 3 3.5 3h9c2 0 3.5-1 3.5-3V7c0-2-1.5-3-3.5-3h-9C5.5 4 4 5 4 7zm8 13c.8 0 1.5-.7 1.5-1.5S12.8 17 12 17s-1.5.7-1.5 1.5S11.2 20 12 20z"
                        />
                      </svg>
                    </div>
            ...
            <div className="hidden md:block">
              <img
                ...
                className="w-[800px] right-[398px] h-full object-contain absolute bottom-[-337px]"
              />
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl text-gray-300">
                  ...
                  <span className="text-teal-primary">complete control of your sales growth</span> with real-time data
                  visualization.
                </p>
                <p className="text-gray-300">
                  Start with our AI-enhanced pre-built dashboards or create your own custom views. Our intelligent
                  system will automatically highlight key trends and opportunities.
                </p>
              </div>
              <div className="space-y-4 pt-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Monitor your sales performance with live updates and AI-driven insights
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
            ...
            >
              <div className="relative rounded-lg overflow-hidden border-2 border-teal-primary/30 shadow-2xl">
                ...
                <img src={Screenshot4} alt="SalesSheets Analytics Dashboard" className="w-full h-auto rounded-lg" />
              </div>
              {/* Decorative Elements */}
        ...
        <div className="container mx-auto px-6 py-24 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl text-gray-300">
                  Dive deep into your data and make better decisions. Our AI-powered platform helps you explore your
                  information dynamically to identify trends and understand your results better.
                </p>
                <p className="text-gray-300">
                  Explore all your data using different{' '}
                  <span className="text-teal-primary">types of visualizations</span> and filters by time periods. Our AI
                  assistant will automatically highlight key insights and opportunities.
                </p>
              </div>
            ...
            <motion.div className="relative" ref={secondSectionRef}>
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10">
                    ...
                    <img src={Screenshot1} alt="Sales Timeline" className="w-full h-auto" />
                  </div>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                ...
                >
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10">
                    ...
                    <img src={Screenshot2} alt="Revenue Distribution" className="w-full h-auto" />
                  </div>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                ...
                >
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10">
                    ...
                    <img src={Screenshot3} alt="Growth Prediction" className="w-full h-auto" />
                  </div>
                </motion.div>
              </div>
              {/* Decorative Elements */}
          ...
          <div className="container mx-auto px-6 py-12">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
              ...
              <div className="col-span-2">
                ...
                <p className="mt-4 text-sm text-gray-400">
                  Transform your sales process with AI-powered insights and automation. Make data-driven decisions and
                  close more deals.
                </p>
            ...
            <div className="mt-12 pt-8 border-t border-white/10">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <p className="text-sm text-gray-400">© {new Date().getFullYear()} SalesSheets. All rights reserved.</p>
