    ...
    <div className="flex h-screen bg-slate-light/10 font-sans">
      <div className="w-full max-w-md m-auto p-8">
        <div className="mb-8 text-center">
          <span className="text-teal-primary text-3xl font-bold mb-4 inline-block">$</span>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-center text-sm">
            <button type="button" onClick={() => setIsSignUp(!isSignUp)} className="text-teal-primary hover:underline">
