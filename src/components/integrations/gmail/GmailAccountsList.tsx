  ...
  if (error) {
    return (
      <div className="text-center py-6">
        ...
        <p className="text-sm text-red-600 mb-2">Error loading Gmail accounts</p>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" onClick={refreshAccounts} disabled={loading.accounts}>
            ...
            <div key={account.id} className="flex items-center gap-3 p-3 border rounded-lg">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">{getLastSyncText(account)}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2" onClick={e => e.stopPropagation()}>
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button variant="outline" size="sm" disabled={loading.accounts}>
                      {loading.accounts ? (
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Are you sure you want to disconnect <strong>{account.email}</strong>? This will stop syncing
                        emails and remove access to this account.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
