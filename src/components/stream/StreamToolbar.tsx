  ...
  return (
    <div className="h-12 border-b border-slate-light/30 flex items-center justify-between px-4 bg-white mt-2">
      ...
      <div className="flex items-center gap-3">
        ...
        <SearchInput value={searchQuery} onChange={setSearchQuery} placeholder="Search lead" width="w-[200px]" />
      </div>

      {/* Right section */}
      <div className="flex items-center gap-2">
        <span className="text-xs bg-slate-light/30 text-slate-dark px-2 py-1 rounded-full">29 Activities</span>
