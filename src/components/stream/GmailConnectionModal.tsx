...
export const GmailConnectionModal = forwardRef<HTMLDivElement, GmailConnectionModalProps>(
  ({ children, onRefresh, contactEmail }, ref) => {
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Manage your Gmail connection and view email data</DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <Card className="border-l-4 border-l-blue-500">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">{status.badge}</div>
                </div>
              </CardHeader>
                    ...
                    {emails && emails.length > 0 && (
                      <div className="space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-muted-foreground">Found {emails.length} emails</span>
                          <Badge variant="outline" className="text-xs">
                            <Database className="h-3 w-3 mr-1" />
                            Database
                          </Badge>
                        </div>
                        <div className="text-xs text-muted-foreground">Data source: Local database</div>
                      </div>
                    )}
                    ...
                    {emailsError && (
                      <Alert>
                        ...
                        <AlertDescription className="flex items-center justify-between">
                          ...
                          <Button variant="outline" size="sm" onClick={refreshEmails} disabled={emailsLoading}>
            ...
            {accounts.length > 0 && (
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium">Connected Accounts ({accounts.length})</CardTitle>
                </CardHeader>
                <CardContent className="pt-0">
                  <div className="space-y-2">
