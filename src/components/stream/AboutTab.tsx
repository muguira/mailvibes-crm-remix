        ...
        case 'select':
          return (
            <Select 
              ...
              open={true}
            >
              <SelectTrigger autoFocus className="border-0 border-b border-[#32BAB0] focus:ring-0 px-0 py-0 rounded-none shadow-none text-sm">
          ...
          >
            {value ? (
              ...
              <div className="text-slate-light">
                {isReadOnly ? 'Not set' : placeholder}
              </div>
            )}
          </div>
        )}
