  ...
  return (
    <div className={`flex items-center justify-between md:justify-around ${className}`}>
      {actions.map((action, index) => (
        ...
        >
          <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center border border-slate-light/30 group-hover:bg-slate-light/10 transition-colors">
            <action.icon size={24} strokeWidth={1.5} className="text-teal-primary" />
          </div>
