  ...
  return (
    <div className="space-y-2">
        ...
        <CardContent className="p-0 flex-1 overflow-hidden">
          {contact?.id ? (
            <div className="h-full flex flex-col">
              <ContactTasksPanel contactId={contact.id} contactName={contact.name} />
            </div>
          ) : (
            <div className="p-4">
              <p className="text-sm text-slate-medium mb-2">Select a contact to view tasks</p>
            </div>
          )}
        </CardContent>
      </Card>
      ...
      <Card className="shadow-sm">
        ...
        <CardContent>
          <p className="text-sm text-slate-medium mb-2">Coming soon</p>
