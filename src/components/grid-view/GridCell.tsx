...
export const GridCell: React.FC<GridCellProps> = ({
  ...
  useEffect(() => {
    ...
    const timeouts = [0, 50, 100, 200, 500].map(delay => setTimeout(repositionCalendar, delay))
    ...
    return (
      ...
      >
        {isEditing ? (
            ...
            >
              ...
              >
                <div className="status-popup-header">
                  ...
                  <button className="status-popup-close" onClick={handleClose} aria-label="Close status popup">
                    ✕
                  </button>
                </div>
                      ...
                      {(column.options || []).map(option => (
                        ...
                        >
                          <div className="flex items-center gap-2 w-full">
                            ...
                            />
                            <span>{option}</span>
                            {displayValue === option && <Check className="ml-auto h-4 w-4" />}
                          </div>
                        </CommandItem>
                      ))}
                    </CommandGroup>
          ...
          <div className="flex justify-center items-center">{renderStatusPill(displayValue, column.colors || {})}</div>
        )}
      </div>
    )
  }
                ...
                <div className="p-5">
                  <Calendar
                    ...
                    classNames={{
                      ...
                      day_selected:
                        '!bg-[#62BFAA] text-white hover:!bg-[#62BFAA] hover:text-white focus:!bg-[#62BFAA] focus:text-white',
  ...
  return (
    ...
    >
      {isEditing ? (
        ...
        <div className="cell-content">{formatCellValue(displayValue, column, row)}</div>
      )}
    </div>
  )
}
