...
const updatedContent2 =
  updatedContent1.slice(0, afterStatePoint) + paginationState + updatedContent1.slice(afterStatePoint)
...
const finalContent = updatedContent2.slice(0, returnStart) + newReturn + updatedContent2.slice(returnEnd)
