...
export function GridToolbar({
  ...
  const baseFilterColumns = columns.filter(col => {
    ...
    return (
      ...
      !col.id.includes('temp_visible')
    ) // Extra safety for any temp columns
  })
  ...
  function handleApplyFilters() {
    ...
    const columnFilters = selectedColumns
      .map(columnId => {
        ...
        <div className="flex items-center">
          ...
          {selectedRowIds.size > 0 && (
            <div className="flex items-center ml-6">
              ...
              <span className="text-sm font-medium text-gray-700 ml-2">{selectedRowIds.size} selected</span>
            </div>
          )}
        </div>
                ...
                if (columnId === '__hidden_columns__' && filterValue) {
                  return (
                    <Badge
                      key={columnId}
                      variant="outline"
                      className="gap-1 max-w-[200px] bg-blue-50 text-blue-700 border-blue-200"
                    >
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <form onSubmit={handleAddContact}>
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="bg-[#32BAB0] hover:bg-[#28a79d] text-white">
                Add Contact
              </Button>
            </DialogFooter>
          </form>
