...
export function GridViewContainer({
  ...
  const contactColumn = columns.find(col => col.id === 'name') || columns.find(col => col.id === 'opportunity')
  ...
  const handleMainGridColumnsReorder = useCallback(
    (columns: Column[]) => {
  ...
  return (
    <div className="grid-view h-full pb-9" ref={containerRef}>
      ...
      <div className="grid-components-container relative">
        ...
        <LoadingOverlay show={columnOperationLoading?.type !== null} message="Processing..." />
        ...
        {data.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-[calc(100vh-200px)] w-full">
            ...
            <p className="text-sm text-gray-500 text-center max-w-sm mb-6">
              Add your first contact to get started. You can add contacts manually or import them from a CSV file or
              Gmail.
            </p>
