...
export const SearchInput: React.FC<SearchInputProps> = React.memo(
  ({ placeholder = 'Search...', value, onChange, className, width = 'w-[240px]', onSubmit, autoFocus }) => {
    ...
    return (
      <form className={cn('relative', width, className)} onSubmit={handleSubmit}>
        <div className="relative">
          ...
          <input
            ...
            className={cn('w-full pl-6 pr-6 py-1 bg-transparent border-b border-gray-300 focus:outline-none', {
