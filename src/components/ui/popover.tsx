...
const AbsolutePopoverContent = React.forwardRef<HTMLDivElement, AbsolutePopoverContentProps>(
  ({ className, position, children, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('fixed bg-white rounded-md border border-slate-200 shadow-lg z-[9999] popover-element', className)}
      style={{
