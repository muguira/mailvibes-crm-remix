...
export function AddPropertyModal({
  ...
  const isFormValid =
    propertyName.trim() !== '' && (propertyType !== 'list' || listOptions.some(option => option.trim() !== ''))
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-6">
          ...
          {getPropertyTypeDescription() && (
            <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded-md">{getPropertyTypeDescription()}</div>
          )}

          {/* List Options - only show for list type */}
          {propertyType === 'list' && (
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">List Options</Label>
              <div className="space-y-2">
                ...
                <Button type="button" variant="outline" size="sm" onClick={handleAddListOption} className="w-full">
          ...
          <div className="space-y-3">
            <Label className="text-sm font-medium text-gray-700">Set Property Options</Label>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox id="enable-filtering" checked={enableFiltering} onCheckedChange={setEnableFiltering} />
