...
export const SettingsLayout: React.FC<SettingsLayoutProps> = ({ children, title = 'Settings' }) => {
              ...
              <div className="bg-white rounded-lg shadow-sm p-4">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <nav className="space-y-1">{accountNavItems.map(renderNavButton)}</nav>
                  </div>

                  {/* Organization Settings */}
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <h2 className="text-sm font-semibold text-gray-900">Organization Settings</h2>
                    </div>
                    ...
                    <div className="mb-4">
                      <div className="relative">
                        ...
                        >
                          ...
                          <ChevronDown
                            size={16}
                            className={cn('text-gray-400 transition-transform', isOrgDropdownOpen && 'rotate-180')}
                          />
                        </button>
                          ...
                          <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                            <div className="p-2">
                              ...
                              <div className="border-t border-gray-100 mt-2 pt-2">
                                <div className="px-3 py-1 text-xs text-gray-500">Switch organizations coming soon</div>
                              </div>
                            </div>
                          </div>
                        )}
                    ...
                    <nav className="space-y-1">{organizationNavItems.map(renderNavButton)}</nav>
                  </div>
                </div>
              </div>
            </div>
