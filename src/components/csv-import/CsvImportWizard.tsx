...
export function CsvImportWizard({ onComplete }: CsvImportWizardProps) {
  ...
  const handleCompleteImport = async () => {
    ...
    try {
      ...
      toast.success(
        `Created ${result.contactsCreated} new contacts${result.contactsUpdated > 0 ? ` and updated ${result.contactsUpdated} existing contacts` : ''}`,
      )
    ...
    switch (currentStep) {
      case 0:
        return (
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Select a CSV file to upload to RelateIQ</h2>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600">
                One column of the CSV will map to the Relationship value of the list. This will determine if the list is
                a Contact or Account based list. Rows missing data for the Relationship column will not be imported.
              </p>
            ...
            <div className="space-y-3">
              ...
              <RadioGroup
                value={relationType}
                onValueChange={value => setRelationType(value as 'contacts' | 'accounts')}
              >
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <Label htmlFor="accounts" className="font-normal cursor-pointer">
                      <span className="font-medium">Accounts</span> (e.g. Opportunities, deals, etc.) - Companies or
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <Label htmlFor="contacts" className="font-normal cursor-pointer">
                      <span className="font-medium">Contacts</span> (e.g. Leads, recruits, etc.) - The people with whom
      ...
      case 1:
        return parsedData ? (
          ...
          <div className="text-center py-8 text-gray-500">No CSV data available</div>
        )
          ...
          <div className="col-span-2">
            <Card>
              <CardHeader className="bg-[#62BFAA] text-white">
                <CardTitle className="text-lg font-medium">{WIZARD_STEPS[currentStep].title}</CardTitle>
              </CardHeader>
              <CardContent className="p-6">
                <Stepper steps={WIZARD_STEPS} currentStep={currentStep} orientation="vertical" />
              </CardContent>
            </Card>
          </div>
