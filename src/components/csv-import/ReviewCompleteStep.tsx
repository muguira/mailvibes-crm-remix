    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 text-sm">
          Here is a preview of the data you will be importing into RelateIQ. If you need
          to make any corrections, click the pencil to edit the information.
        </p>
        <p className="text-gray-600 text-sm mt-2">
          Click Save to see the complete your import and create your new List: test.
        </p>
        <p className="text-gray-600 text-sm">
          Accounts or Contacts you did not add to test are stored in your Account and
          Contact Galleries.
        </p>
      </div>
