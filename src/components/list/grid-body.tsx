...
export function GridBody({
  ...
  const firstRowIndex = data.length > 0 && 'originalIndex' in data[0] ? (data[0].originalIndex as number) : 0
    ...
    <div className="overflow-auto flex-1 bg-white" ref={bodyRef}>
      ...
      <div className="grid-row h-[var(--row-height,32px)] bg-white border-0 hover:bg-slate-light/5">
        ...
        <div
          ...
          style={{
            gridTemplateColumns: `repeat(${frozenColumns.length + scrollableColumns.length}, minmax(var(--cell-min-width, 150px), 1fr))`,
          }}
        >
