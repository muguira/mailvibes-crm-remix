...
export function GridDatePicker({ isOpen, position, selectedDate, onClose, onSelect, popoverRef }: DatePickerProps) {
  ...
  return (
    <AbsolutePopoverContent ref={popoverRef} position={position} className="calendar-popup z-[1200]">
