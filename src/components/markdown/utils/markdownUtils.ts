...
export const handleFormatting = (
  ...
  switch (format) {
    ...
    case 'numberedList':
      ...
      const currentNumberedListItem = range.startContainer.parentElement?.closest('li')
      const currentNumberedList = currentNumberedListItem?.parentElement

      if (currentNumberedListItem && currentNumberedList?.tagName.toLowerCase() === 'ol') {
        // Exit numbered list
        ...
        if (selectedText) {
          ...
          listElement.className = 'list-decimal list-outside space-y-1 my-3 pl-6'
          const listItem = document.createElement('li')
          listItem.className = 'mb-1'
          listItem.textContent = selectedText
          listElement.appendChild(listItem)
    ...
    case 'heading3':
      ...
      if (selectedText) {
        ...
        headingElement.className = headingClasses[headingTag as keyof typeof headingClasses]
        ...
        const currentHeading = (currentElement as Element)?.closest('h1, h2, h3, h4, h5, h6')
