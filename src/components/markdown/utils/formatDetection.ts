 ...
 */
export const detectActiveFormats = (editableElement: HTMLElement | null): Set<string> => {
 ...
 */
export const cleanupMarginsAndFormatting = (editableElement: HTMLElement | null) => {
  if (!editableElement) return

  // Find all normal paragraphs and ensure they have no margins
  const normalParagraphs = editableElement.querySelectorAll('.normal-paragraph')
