      ...
      >
        ...
        >
          <button
            ...
            title="Bold"
          >
            <Bold className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          <button
            ...
            title="Italic"
          >
            <Italic className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          ...
          {(!isMobile || isToolbarExpanded) && (
            <>
              <button
                ...
                title="Underline"
              >
                <Underline className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
              </button>
              <button
                ...
                title="Bullet List"
              >
                <List className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
              </button>
              <button
          ...
          <div className="relative emoji-picker">
            <button
              ...
              title="Insert Emoji"
            >
              <Smile className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
            </button>
        ...
        >
          <button
            ...
            title="Strikethrough"
          >
            <Strikethrough className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          <button
            ...
            title="Inline Code"
          >
            <Code className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          <button
            ...
            title="Heading 1"
          >
            <Heading1 className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          <button
            ...
            title="Heading 2"
          >
            <Heading2 className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          <button
            ...
            title="Heading 3"
          >
            <Heading3 className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          <button
            ...
            title="Quote"
          >
            <Quote className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          <button
            ...
            title="Insert Link"
          >
            <Link className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          <button
            ...
            title="Code Block"
          >
            <Code2 className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
          <button
          ...
          >
            <Minus className={`transition-all duration-300 ease-in-out ${isCompact ? 'w-3 h-3' : 'w-4 h-4'}`} />
          </button>
        </div>
      </div>
