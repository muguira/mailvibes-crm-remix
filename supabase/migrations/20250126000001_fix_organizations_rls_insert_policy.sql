-- Fix RLS policies for organizations table to allow organization creation
-- This resolves the issue where users with cancelled invitations cannot create new organizations
