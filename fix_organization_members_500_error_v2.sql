-- =============================================
-- FIX FOR 500 ERROR: organization_members table (V2)
-- =============================================
...
-- V2: Fixed function signature conflicts

-- Step 1: Drop existing functions that might have conflicting signatures
...
-- Step 2: Temporarily disable RLS to work safely
...
-- Step 4: Create a simple function to check organization membership
...
-- Policy 2: Users can view members of organizations they belong to
...
-- Policy 3: Only admins can insert new members
...
-- Policy 4: Only admins can update members
...
-- Step 7: Recreate the RPC functions with error handling
...
-- Step 8: Recreate get_organization_members_safe function
...
-- Step 9: Recreate get_organization_details_safe function if it doesn't exist
...
-- Success message
SELECT 'Organization members 500 error fix v2 completed successfully!' as status; 